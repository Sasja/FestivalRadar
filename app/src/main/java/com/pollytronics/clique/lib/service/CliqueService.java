 ...
 *
 * HINT: use a list of subServices to pass on the onEvent callbacks instead of manually calling them, look into EvenListener interface and its subclasses
 * HINT: consider using smth like PreferenceChangeListener interfaces instead of notifyNewSettings
 */
